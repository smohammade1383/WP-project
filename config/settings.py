...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-@4(1-cbvg9$2@8kf!_zi#(-a%^el)$+mmw33@y)wf0mooyssxb")
...
if os.getenv("DB_ENGINE", "sqlite").lower() == "postgres":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "wp_project"),
...
# Keep PK strategy aligned with existing migrations/apps (BigAutoField IDs).
