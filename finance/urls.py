...
from .views import (
    BailPaymentRequestAPIView,
    BailPaymentVerifyAPIView,
...
urlpatterns = [
    ...
    path("bail/request/", BailPaymentRequestAPIView.as_view(), name="bail-request"),
    path("bail/verify/", BailPaymentVerifyAPIView.as_view(), name="bail-verify"),
]
